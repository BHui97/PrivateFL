...
python FedTransfer.py --data='cifar100' --nclient=100 --nclass=100 --ncpc=2 --encoder='clip' --model='linear_model_DN_IN' --mode='LDP' --round=30 --epsilon=2 --sr=1 --lr=1 --flr=1e-1 --physical_bs=64 --E=2 --bs=256
...
python FedTransfer.py --data='cifar100' --nclient=100 --nclass=100 --ncpc=2 --encoder='clip' --model='linear_model_DN_IN' --mode='LDP' --round=35 --epsilon=6 --sr=1 --lr=1 --flr=1e-1 --physical_bs=64 --E=2 --bs=256
python FedTransfer.py --data='cifar100' --nclient=100 --nclass=100 --ncpc=2 --encoder='clip' --model='linear_model_DN_IN' --mode='LDP' --round=30 --epsilon=4 --sr=1 --lr=1 --flr=1e-1 --physical_bs=64 --E=2 --bs=256
