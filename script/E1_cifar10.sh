...
python FedAverage.py --data='cifar10' --nclient=100 --nclass=10 --ncpc=2 --model='resnet18_IN' --mode='LDP' --round=150 --epsilon=4 --sr=1 --lr=1e-1 --flr=1e-1 --physical_bs=3 --E=1
python FedAverage.py --data='cifar10' --nclient=100 --nclass=10 --ncpc=2 --model='resnet18_IN' --mode='LDP' --round=150 --epsilon=6 --sr=1 --lr=1e-1 --flr=1e-1 --physical_bs=3 --E=1
python FedAverage.py --data='cifar10' --nclient=100 --nclass=10 --ncpc=2 --model='resnet18_IN' --mode='LDP' --round=200 --epsilon=8 --sr=1 --lr=1e-1 --flr=1e-1 --physical_bs=3 --E=1
